...
var CookieAlert = {
	...
	options : {
		...
		cookiePolicy: 'http://www.allaboutcookies.org/'
	},
	...
	init : function(options) {
		...
		window.onload = function() {
			...
			switch(CA.options.style)
			{
			  ...
			  case 'dark':  style += 'background-color:#1b1b1b; color:#FF6600; border-top:1px solid #444; border-bottom:1px solid #444;'; break;
			}
